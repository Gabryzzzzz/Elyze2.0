...
namespace Elyze.Migrations
{
    ...
    [Migration("20230502075235_InserimentiReDesignFix2")]
    partial class InserimentiReDesignFix2
    {
            ...
            modelBuilder.Entity("Elyze.Data.CampiMa", b =>
                {
                    ...
                    b.HasOne("Elyze.Data.UnitaMisura", "IdUDMAreaNavigation")
                        .WithMany()
                        .HasForeignKey("IdUDM")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("IdUDMAreaNavigation");
                });

            modelBuilder.Entity("Elyze.Data.InserimentiFissi", b =>
                {
                    b.HasOne("Elyze.Data.Inserimenti", "IdInserimentoNavigation")
                        .WithMany()
                        .HasForeignKey("IdInserimento")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                    ...
                    b.Navigation("IdInserimentoNavigation");
