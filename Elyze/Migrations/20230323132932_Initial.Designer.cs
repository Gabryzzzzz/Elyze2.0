...
namespace Elyze.Migrations
{
    ...
    [Migration("20230323132932_Initial")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Elyze.Data.Area", b =>
                {
                    ...
                    b.Property<string>("IconaArea")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("IconaSdg")
                        .HasColumnType("nvarchar(max)");
            ...
            modelBuilder.Entity("Elyze.Data.Societum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elyze.Data.UserSocietum", b =>
                {
                    b.Property<int>("UserId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elyze.Data.Valutum", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Elyze.Data.OperatoreDiConversione", b =>
                {
                    b.HasOne("Elyze.Data.Operazione", "IdOperazioneNavigation")
                        .WithMany("OperatoreDiConversiones")
            ...
            modelBuilder.Entity("Elyze.Data.UserSocietum", b =>
                {
                    b.HasOne("Elyze.Data.Societum", "Societa")
            ...
            modelBuilder.Entity("Elyze.Data.Operazione", b =>
                {
                    b.Navigation("OperatoreDiConversiones");
                });
